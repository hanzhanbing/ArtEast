...
//#define AppSecret [[NSUserDefaults standardUserDefaults] objectForKey:@"AppSecret"] //加密传输秘钥
//#define ProductUrl [[NSUserDefaults standardUserDefaults] objectForKey:@"ProductUrl"]
//#define WebUrl [[NSUserDefaults standardUserDefaults] objectForKey:@"WebUrl"]
//#define PictureUrl [[NSUserDefaults standardUserDefaults] objectForKey:@"PictureUrl"]

//#define AppSecret @"ea1af2ad4527edb95ad492943b986d6d426d99381953f10465a0ce6504b62a3e" //加密传输秘钥
//#define ProductUrl @"http://192.168.1.6/api"
//#define WebUrl @"http://192.168.1.6/"
//#define PictureUrl @"http://192.168.1.6/"

//#define AppSecret @"325304c6db66dece54350ee3ace6b65ff550851f3386d3b90e25446866d315cc" //加密传输秘钥
//#define ProductUrl @"http://beta.cydf.com/api"
//#define WebUrl @"http://beta.cydf.com/"
//#define PictureUrl @"http://beta.cydf.com/"
...
//#define AppSecret @"325304c6db66dece54350ee3ace6b65ff550851f3386d3b90e25446866d315cc" //加密传输秘钥
//#define ProductUrl @"https://app.cydf.com/api"
//#define WebUrl @"https://app.cydf.com/"
//#define PictureUrl @"https://beta-cydf-img.oss-cn-beijing.aliyuncs.com/"

//#define AppSecret @"ea1af2ad4527edb95ad492943b986d6d426d99381953f10465a0ce6504b62a3e" //加密传输秘钥
//#define ProductUrl @"https://appi.cydf.com/api"
//#define WebUrl @"https://appi.cydf.com/"
//#define PictureUrl @"https://images-app.cydf.com/"


#pragma mark - ---------------网页地址---------------

#define HTML_HomePage [NSString stringWithFormat:@"%@%@",WebUrl,@"wap/app.html"] //首页
#define HTML_NewExclusive [NSString stringWithFormat:@"%@%@",WebUrl,@"web/newExclusive/newExclusive.html"] //新人专享
#define HTML_Seckill [NSString stringWithFormat:@"%@%@",WebUrl,@"web/seckill/seckill.html"] //限时抢购
#define HTML_FindPage [NSString stringWithFormat:@"%@%@",WebUrl,@"web/content/contentHome.html"] //精选话题
#define HTML_DesignSay [NSString stringWithFormat:@"%@%@",WebUrl,@"web/designerSays/designerSays.html"] //设计师说
#define HTML_AddressPage [NSString stringWithFormat:@"%@%@",WebUrl,@"web/retailer/addressment.html?from=0"] //地址列表页
#define HTML_OrderConfirmPage [NSString stringWithFormat:@"%@%@",WebUrl,@"web/retailer/order2.html"] //订单确认页
#define HTML_CouponPage [NSString stringWithFormat:@"%@%@",WebUrl,@"web/user/shoppVouchers.html?from=0"] //优惠券页
#define HTML_HelpCenter [NSString stringWithFormat:@"%@%@",WebUrl,@"web/helpCenter/helpCenter.html"] //帮助中心
#define HTML_GoodsDetailComment [NSString stringWithFormat:@"%@%@",WebUrl,@"web/content/goodsComment.html?goodsId="] //商品详情评论
#define HTML_GoodsDetailFav [NSString stringWithFormat:@"%@%@",WebUrl,@"web/active/likeGoods/likeGoods.html?goodsId="] //商品详情喜欢
