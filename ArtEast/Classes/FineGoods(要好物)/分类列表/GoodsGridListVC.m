...
@interface GoodsGridListVC ()<UICollectionViewDelegate,UICollectionViewDataSource,RefreshDelegate>
...
@implementation GoodsGridListVC
...
- (void)initView {
    _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, WIDTH, WIDTH/2)];
    _imageView.alpha = 0;
        ...
        if (status == Request_Success) {
            ...
            if (![Utils isBlankString:responseData]) {
                ...
                if (_dataArr.count==0) {
                    ...
                    [_imageView sd_setImageWithURL:[NSURL URLWithString:self.typeInfo.picture] placeholderImage:[UIImage imageNamed:@"ClassifyDefaultIcon"]];
