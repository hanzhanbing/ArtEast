...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    _photoButton.titleLabel.font = kFont13Size;
    _photoButton.titleEdgeInsets = UIEdgeInsetsMake(80, -_photoButton.titleLabel.bounds.size.width-60, 0, 0);//设置title在button上的位置（上top，左left，下bottom，右right）
    ...
    _locationButton.titleLabel.font = kFont13Size;
    _locationButton.titleEdgeInsets = UIEdgeInsetsMake(80, -_locationButton.titleLabel.bounds.size.width-60, 0, 0);//设置title在button上的位置（上top，左left，下bottom，右right）
    ...
    _takePicButton.titleLabel.font = kFont13Size;
    _takePicButton.titleEdgeInsets = UIEdgeInsetsMake(80, -_takePicButton.titleLabel.bounds.size.width-60, 0, 0);//设置title在button上的位置（上top，左left，下bottom，右right）
