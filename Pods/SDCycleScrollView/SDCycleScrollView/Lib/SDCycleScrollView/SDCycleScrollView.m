...
#define kCycleScrollViewInitialPageControlDotSize CGSizeMake(12, 12)
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.imageView.tag = 10000+itemIndex;
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    self.currentImageView = [self viewWithTag:10000+indexOnPageControl];
